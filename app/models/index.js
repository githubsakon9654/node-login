...
db.supcate = require("../models/supcate.model.js")(sequelize, Sequelize);
db.ducate = require("./ducate.model")(sequelize, Sequelize);
db.cls = require("./class.model")(sequelize, Sequelize);

db.cls.hasMany(db.user, { as: 'users' });
db.user.belongsTo(db.cls, {
    foreignKey: 'claId',
    as: 'clas'
});
...
db.supcate.hasMany(db.supplie, { as: 'supplies' });
db.supplie.belongsTo(db.supcate, {
    foreignKey: 'supcateId',
    as: 'supcates'
});
...
db.cls.hasMany(db.durable, { as: "durables" });
db.durable.belongsTo(db.cls, {
    foreignKey: "claId",
    as: "clas"
});
