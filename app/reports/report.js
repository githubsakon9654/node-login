...
SELECT DATE_FORMAT( rv.createdAt, "%d %M %Y") AS date,rv.serial AS serial,'-' AS price,users.fullname AS name,'-' AS units,'-' AS sum,rs.unit,(rs.unit*s.price) AS prices,rs.remain AS remain,(rs.remain*s.price) AS sums FROM reveals AS rv
    ...
    rows.push(
        [
            { text: 'วัน เดือน ปี', style: 'fillheader', rowSpan: 2, alignment: 'center' }, { text: 'รับจาก/จ่ายให้', style: 'fillheader', rowSpan: 2, alignment: 'center' },
            { text: 'เลขที่เอกสาร', style: 'fillheader', rowSpan: 2, alignment: 'center' },
            { text: 'ราคาต่อหน่วย', style: 'fillheader', rowSpan: 2, alignment: 'center' }, { text: 'รับ', style: 'fillheader', colSpan: 2, alignment: 'center' }, {},
            { text: 'จ่าย', style: 'fillheader', colSpan: 2, alignment: 'center' }, {},
            { text: 'คงเหลือ', style: 'fillheader', colSpan: 2, alignment: 'center' }, {},
        ], [
            {}, {}, {}, {}, { text: 'จำนวน', style: 'fillheader' }, { text: 'ราคา', style: 'fillheader' },
            { text: 'จำนวน', style: 'fillheader' }, { text: 'ราคา', style: 'fillheader' },
            { text: 'จำนวน', style: 'fillheader' }, { text: 'ราคา', style: 'fillheader' },
        ]
    );
    ...
    pdfDoc.getBase64((data) => {
        res.writeHead(200, {
            ...
            'Content-Disposition': 'attachment;filename="suppliehistory.pdf"'
        });
...
exports.revealDetail = async(req, res, next) => {
    try {
      ...
      sup.price,sb.unit,sup.unit_name,sb.supplieId,bf.createdAt,bf.serial FROM reveals AS bf
